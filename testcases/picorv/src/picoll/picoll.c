...
unsigned long long addl(unsigned long long a, unsigned long long b) {
return a + b;
}

unsigned long long subl(unsigned long long a, unsigned long long b) {
return a - b;
}

unsigned long long mull(unsigned long long a, unsigned long long b) {
return a * b;
}

long long divl(long long a, long long b) {
return a / b;
}
...
int main()
{
	...
	unsigned long long a = 0x77543210ll;
	unsigned long long b = -0x1234567ll;
	c = addl(a,b);
	pico_snprintf(str, sizeof(str), "%lld + %lld  = %lld\r\n", a, b ,c);
	puts(str);
	c = subl(a,b);
	pico_snprintf(str, sizeof(str), "%lld - %lld  = %lld\r\n", a, b ,c);
	puts(str);
